...
const { getAllUsers, getUser, editUser, deleteUser, createUser, followFunc, unfollowFunc, getFollowers, getFollowing, loginUser, logout, getMe, suggestedUsers } = require('../controllers/userController');
...
router.route('/user/suggestion').get(isAuthenticatedUser, suggestedUsers);
